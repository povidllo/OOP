...
class GraphIncMtxTest {

    GraphIncMtx mtx = new GraphIncMtx(3);
    ...
    void addVertex2() {
        ...
        mtx.addVertex(5);
        mtx.addEdge(5, 1);
        assertEquals(mtx.toString(), "{1=[2], 2=[], 3=[], 4=[], 5=[1]}");
    ...
    void removeVertex() {
        ...
        assertEquals(mtx.toString(), "{1=[], 2=[], 3=[], 4=[1]}");
    }
    ...
    @Test
    void testEqualsWithAdjListFalse() {
        GraphAdjList newMtx = new GraphAdjList();
        newMtx.addVertex(1);
        newMtx.addVertex(2);
        newMtx.addVertex(3);
